...
#for h3k4me3
macs3_data_h3k4me3 = pd.read_csv("D:/peakCalling/gopeaks-compare-main/data/evaluate_models/macs3_k562_h3k4me3.txt", delimiter='\t')
macs2_data_h3k4me3 = pd.read_csv("D:/peakCalling/gopeaks-compare-main/data/evaluate_models/macs2_k562_h3k4me3.txt", delimiter='\t')
...
plt.plot(fpr_macs3_data_h3k4me3, tpr_macs3_data_h3k4me3, label=f"MACS3 (AUC = {auc_macs3_data_h3k4me3:.2f})", linewidth=2, color='blue')

# Plot MACS3 ROC curve
plt.plot(fpr_macs2_data_h3k4me3, tpr_macs2_data_h3k4me3, label=f"MACS2 (AUC = {auc_macs2_data_h3k4me3:.2f})", linewidth=2, color='red')
...
plt.title('ROC curve for H3K4me3')
...
plt.plot(tpr_macs3_data_h3k4me3, pre_macs3_data_h3k4me3, label=f"MACS3 PR", linewidth=2, color='blue')

# Plot MACS2 Precision-Recall curve
plt.plot(tpr_macs2_data_h3k4me3, pre_macs2_data_h3k4me3, label=f"MACS2 PR", linewidth=2, color='red')
...
plt.title('Precision-Recall curve for H3K4me3')
