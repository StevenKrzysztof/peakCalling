...
file=$(find data/macs3/runningData -name "${sample}*Peak") # this workaround accommodates for narrowPeak and broadPeak inputs
...
sample_file=$(awk -v OFS='\t' '{print $0,10**-$8}' $file | grep -vi "inf" | sort -rg -k11)
