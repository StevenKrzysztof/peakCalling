...
#   full_command="macs3 callpeak -f BAMPE --broad --broad-cutoff 0.1 -g hs -t data/uniq_hits/${file}_uniq_hits.bam -n data/macs3/${file}/${file}_pewb"
#
#   # Execute the command
...
#
#   # Build the full command for each file
#   full_command="macs3 callpeak -f BAMPE -g hs -t data/uniq_hits/${file}_uniq_hits.bam -n data/macs3/${file}/${file}_pew"
#
#   # Execute the command
#   echo "Running command for file: ${file}"
#   $full_command
